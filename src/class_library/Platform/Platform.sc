Platform {
	...
	*initClass {
	...
	initPlatform {
		...
		// In constrained runtimes (e.g. WASM) platform directory primitives may be unavailable.
		recordingsDir = classLibraryDir ++ "/Recordings";
	}
