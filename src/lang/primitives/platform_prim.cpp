...
#include "filesystem.hpp" // path_to_utf8_str
#include "language_config.hpp" // getIdeName
#include "primitive.h"
#include "kernel.h"
#include "sc_base.h" // getsym
#ifdef _WIN32
...
int prPlatform_architecture(struct VMGlobals* g, int numArgsPushed) {
    ...
    SetSymbol(g->sp, getsym("wasm64"));
#elif defined(__wasm32__)
    SetSymbol(g->sp, getsym("wasm32"));
